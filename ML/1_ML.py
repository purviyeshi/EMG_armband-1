...
X_train_output_1 = np.array([
        ...
        [0.07190354, 0.08225045, 0.70419871, 0.3491307, 0.94422577],
        [0.78521738, 0.02727707, 0.21229789, 0.59866947, 0.89588859],
        [0.78198242, 0.2659453, 0.90850376, 0.03403553, 0.26650027]
    ])
...
X_train_output_2 = np.array([
        ...
        [0.32287345, 0.78201594, 0.55483676, 0.57196347, 0.97146068],
        [0.48616349, 0.05904124, 0.42013775, 0.50583606, 0.36310962],
        [0.59673238, 0.45847252, 0.10836348, 0.31863487, 0.91711626]
    ])
...
X_train_output_3 = np.array([
        ...
        [0.47539437, 0.81452077, 0.70455928, 0.01512045, 0.52208648],
        [0.58859819, 0.50439184, 0.11956409, 0.62563531, 0.49576051],
        [0.62006733, 0.48769503, 0.75715038, 0.02098693, 0.98054508]
    ])
...
X_train_output_4 = np.array([
        ...
        [0.77315855, 0.52897692, 0.09408296, 0.94611859, 0.27414343],
        [0.02120476, 0.23212049, 0.0074043, 0.90501623, 0.35927341],
        [0.4823455, 0.19055184, 0.65837775, 0.60645597, 0.65236373]
    ])
...
X_train_output_5 = np.array([
        ...
        [0.38190642, 0.68697017, 0.2411733, 0.73954013, 0.15147928],
        [0.69193103, 0.27238206, 0.49336069, 0.55681858, 0.90117867],
        [0.27097688, 0.09426942, 0.17913661, 0.00511653, 0.17556956]
    ])
...
X_train_output_6 = np.array([
        ...
        [0.48600785, 0.77494237, 0.01830693, 0.41165082, 0.75931791],
        [0.59598306, 0.67345714, 0.64591846, 0.22347038, 0.64196091],
        [0.24793755, 0.26929753, 0.07252067, 0.23973119, 0.07952221]
    ])
...
X_train_output_7 = np.array([
        ...
        [0.145974, 0.45274634, 0.96279523, 0.98146133, 0.1058281],
        [0.01062426, 0.97107726, 0.7685072, 0.9738644, 0.74064653],
        [0.96418117, 0.23807957, 0.97478495, 0.30283069, 0.1363624]
    ])
...
X_train_features_combined = np.concatenate((X_train_features_1, X_train_features_2, X_train_features_3, X_train_features_4, X_train_features_5, X_train_features_6, X_train_features_7), axis=1)


# Convert y_train_one_hot for all 7 outputs to a single array
y_train_one_hot_combined = np.concatenate((y_train_one_hot_1, y_train_one_hot_2, y_train_one_hot_3, y_train_one_hot_4, y_train_one_hot_5, y_train_one_hot_6, y_train_one_hot_7),axis=1)
...
# print(X_train_features_combined.shape)
# print(y_train_one_hot_combined.shape)
# print(y_train_one_hot_3.shape)
# print(y_train_one_hot_4.shape)
# print(y_train_one_hot_5.shape)
# print(y_train_one_hot_6.shape)
# print(y_train_one_hot_7.shape)

# print(X_train_features_combined.shape, y_train_one_hot_combined.shape)
#
# print("Output 1 shapes:", X_train_features_1.shape, y_train_one_hot_1.shape)
# print("Output 2 shapes:", X_train_features_2.shape, y_train_one_hot_2.shape)
# print("Output 3 shapes:", X_train_features_3.shape, y_train_one_hot_3.shape)
# print("Output 4 shapes:", X_train_features_4.shape, y_train_one_hot_4.shape)
# print("Output 5 shapes:", X_train_features_5.shape, y_train_one_hot_5.shape)
# print("Output 6 shapes:", X_train_features_6.shape, y_train_one_hot_6.shape)
# print("Output 7 shapes:", X_train_features_7.shape, y_train_one_hot_7.shape)
#
# print("X_train_features_1",X_train_features_1)
#
# print("y_train_one_hot_1",y_train_one_hot_1)
